...
/***/ function(module, exports, __webpack_require__) {
	...
	var todoStore = _mobservable2['default'].makeReactive({
	    todos: [{
	...
	todoStore.inc3 = function (x) {
	    return todoStore.count3 = x;
	};
	...
	var SetCount = (function (_React$Component) {
	    _inherits(SetCount, _React$Component);
	    ...
	    function SetCount(props) {
	        ...
	        _get(Object.getPrototypeOf(SetCount.prototype), 'constructor', this).call(this, props);

	        this.render = function () {
	            return _react2['default'].createElement('input', { type: 'text', onKeyDown: _this.handleEnter.bind(_this), onClick: _this.click.bind(_this),
	...
	var ToList = (function (_React$Component2) {
	    _inherits(ToList, _React$Component2);
	    ...
	    function ToList(props) {
	        ...
	        _get(Object.getPrototypeOf(ToList.prototype), 'constructor', this).call(this, props);
	        ...
	        this.render = function () {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'ul',
	                    null,
	                    store.todos.map(function (item, idx) {
	                        return _react2['default'].createElement(TodoView, { store: store, todo: item, key: idx });
	                    }),
	                    store.pending ? _react2['default'].createElement(
	                        'li',
	                        null,
	                        'Loading more items...'
	                    ) : null
	                ...
	                _react2['default'].createElement(
	                    'button',
	                    { onClick: _this2.onNewTodo },
	                    'New Todo'
	                ),
	                _react2['default'].createElement(
	                    'button',
	                    { onClick: _this2.loadMore },
	                    'Load more...'
	                ),
	                _react2['default'].createElement('br', null),
	                _react2['default'].createElement('br', null),
	                'Enter anything then click or press \'Enter\': ',
	                _react2['default'].createElement(SetCount, { change: store.inc3 }),
	                _react2['default'].createElement(
	                    'h1',
	                    null,
	                    store.count3
	        ...
	        this.onNewTodo = function () {
	            _this2.store.addTodo(prompt('Enter a new todo:', 'Try mobservable at home!'));
	        };

	        this.loadMore = function () {
	            _this2.store.loadTodosAsync();
	        };
	...
	var ToView = (function (_React$Component3) {
	    _inherits(ToView, _React$Component3);

	    function ToView() {
	        var _this3 = this;

	        _classCallCheck(this, ToView);

	        _get(Object.getPrototypeOf(ToView.prototype), 'constructor', this).apply(this, arguments);

	        this.render = function () {
	            count += 1;
	            console.log('__________________________________ToDoView rendered ' + count + ' times.');
	            var todo = _this3.props.todo;
	            return _react2['default'].createElement(
	                'li',
	                null,
	                _react2['default'].createElement('input', { type: 'checkbox', checked: todo.completed, onChange: _this3.onToggleCompleted }),
	                todo.title,
	                ' ',
	                _react2['default'].createElement(
	                    'a',
	                    { href: '#', onClick: _this3.onEdit },
	                    '[edit]'
	                ),
	                _react2['default'].createElement(
	                    'a',
	                    { href: '#', onClick: _this3.onRemove },
	                    '[remove]'
	                )
	            );
	        };
	        ...
	        this.onToggleCompleted = function () {
	            _this3.props.todo.completed = !_this3.props.todo.completed;
	        };

	        this.onEdit = function (e) {
	            e.preventDefault();
	            _this3.props.todo.title = prompt('Todo:', _this3.props.todo.title);
	        };

	        this.onRemove = function (e) {
	            e.preventDefault();
	            _this3.props.store.removeTodo(_this3.props.todo);
	        };
	    }
	...
	;
	var TodoView = _mobservable2['default'].reactiveComponent(ToView);
	var TodoList = _mobservable2['default'].reactiveComponent(ToList);
	_react2['default'].render(_react2['default'].createElement(TodoList, null), document.getElementById('approot'));
